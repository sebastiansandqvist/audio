        ...
        React.useEffect(function () {
            ...
            // piano keys
            {
                for (var i = 0; i < fullScale.length; i++) {
                    ...
                    var key = (pitch.includes('#') || pitch.includes('b')) ? pianoKeys.black : pianoKeys.white;
                    var x = 0;
    ...
    function App() {
        ...
        var updateSong = function (songId, updates) {
            setSongs(function (songs) {
                var _a;
                return __assign(__assign({}, songs), (_a = {}, _a[songId] = Object.assign({}, songs[songId], updates), _a));
            });
        };
